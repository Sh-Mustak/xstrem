...
function VideoDetails({ id }) {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-color-bg text-white font-exo">
      <div className="bg-color-dark rounded-lg shadow-lg max-w-5xl w-full p-6 overflow-hidden">
